          ...
          <div className="order-2 lg:order-1 lg:w-1/3 flex flex-col justify-center items-center lg:h-screen lg:fixed lg:top-24 lg:left-0 mr-8">
            ...
            {!productData.video ? (
              ...
              <div className="flex flex-col items-center">
                <video src={URL.createObjectURL(productData.video)} controls className="mt-4 w-48 h-48 object-cover rounded-lg"/>
                <button type="button" onClick={() => setProductData({ ...productData, video: null })}
